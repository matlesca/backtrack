<template>
  <div class="navbar-wrapper">
    <a class="nav-main-btn" type="button" v-on:click.prevent="toggleAppLoading()">
...
.nav-burger {position: absolute; top: 40px; left: 215px; width: 15px; height: 19px;}
